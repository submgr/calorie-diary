...
.text-a1 {
  ...
  import { IonContent, IonPage, IonDatetime, IonHeader, IonToolbar, IonTitle, IonList, IonSegment, IonModal, IonButton, IonInput, IonItem } from '@ionic/vue';

  import FoodListElement from '../components/FoodListElement.vue'
  import {RecycleScroller, RecycleScrollerItem, DynamicScroller, DynamicScrollerItem} from 'vue-virtual-scroller'
  ...
  export default defineComponent({
    name: 'Tab3Page',
    components: { IonDatetime, IonHeader, IonToolbar, IonTitle, IonContent, DynamicScroller, DynamicScrollerItem, IonList, IonPage, RecycleScroller, IonItem, IonSegment, IonModal, IonButton, IonInput },
    data () {
      return {
        modalState: "none",
