<template>
  <ion-page>
                ...
                <ion-item>
                  <ion-grid class="ionlist_custom">
                    <ion-row class="ionlist_custom">
                      ...
                      <ion-col size="2"><ion-icon :icon="trashOutline" class="ion-iconzed" @click="deleteRow(row.unique)" style="margin-left: 0vw; font-size: 37px; color: red; opacity: 0.4; margin-top: 1vh;" /></ion-col>
                    </ion-row>
                  </ion-grid>
    ...
    <ion-modal
                ...
                :is-open="modalState == 'addOwnFoodModal'"
                trigger="open-modal"
